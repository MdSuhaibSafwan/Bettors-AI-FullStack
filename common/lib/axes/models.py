...
class AccessFailureLog(AccessBase):
    ...
    class Meta:
        verbose_name = verbose_name_plural = "03_Access Failure"
...
class AccessAttempt(AccessBase):
    ...
    post_data = SearchField(
        hash_key=settings.ENCRYPTION_HASH_KEY,
        encrypted_field_name="_post_data",
    )
    ...
    class Meta:
        verbose_name = (
            verbose_name_plural
        ) = "01_Authentication Failures/Account Lock Logs (Delete this log when unlocking)"
...
class AccessLog(AccessBase):
    ...
    class Meta:
        verbose_name = verbose_name_plural = "02_Successful Authentication Logs"
